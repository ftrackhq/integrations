...
event_paths = [
    os.path.abspath(os.path.join(CWD, '..', '..', 'ftrack-connect-pipeline-definition', 'resource', 'application_hook')),
    os.path.abspath(os.path.join(CWD, '..', '..', 'ftrack-connect-pipeline', 'resource', 'application_hook'))
]
