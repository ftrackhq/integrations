...
class NukeScriptOptionsSelectorWidget(BaseWidget):
    '''Main class to represent a script widget on a publish process.'''

    name = 'nuke_script_options_selector'
    ui_type = 'qt'
    ...
    def build_ui(self):
        ...
        self._export_type_cb.addItems(["script", "selection"])
