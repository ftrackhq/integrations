...
project = u'ftrack_connect_pipeline_maya'
copyright = u'2022, ftrack'
author = u'ftrack'

# contents of docs/conf.py
try:
    release = get_distribution('ftrack_connect_pipeline_maya').version
...
modindex_common_prefix = ['ftrack_connect_pipeline_maya.']
...
htmlhelp_basename = 'ftrack_connect_pipeline_mayadoc'
...
latex_documents = [
    (
        master_doc,
        'ftrack_connect_pipeline_maya.tex',
        u'ftrack_connect_pipeline_maya Documentation',
        u'ftrack',
        'manual',
    ),
]
