...
project = u'framework_nuke'
copyright = u'2022, ftrack'
author = u'ftrack'

# contents of docs/conf.py
try:
    release = get_distribution('framework_nuke').version
...
modindex_common_prefix = ['framework_nuke.']
...
htmlhelp_basename = 'framework_nukedoc'
...
latex_documents = [
    (
        master_doc,
        'framework_nuke.tex',
        u'framework_nuke Documentation',
        u'ftrack',
        'manual',
    ),
]
