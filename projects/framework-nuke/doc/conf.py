...
project = u'ftrack_framework_nuke'
copyright = u'2022, ftrack'
author = u'ftrack'

# contents of docs/conf.py
try:
    release = get_distribution('ftrack_framework_nuke').version
...
modindex_common_prefix = ['ftrack_framework_nuke.']
...
htmlhelp_basename = 'ftrack_framework_nukedoc'
...
latex_documents = [
    (
        master_doc,
        'ftrack_framework_nuke.tex',
        u'ftrack_framework_nuke Documentation',
        u'ftrack',
        'manual',
    ),
]
...
man_pages = [
    (
        master_doc,
        'framework-nuke',
        u'framework-nuke Documentation',
        [author],
        1,
    )
]
