...
def on_discover_ftrack_framework_nuke(session, event):
    from ftrack_framework_nuke import __version__ as integration_version
...
def register(session):
    ...
    handle_discovery_event = functools.partial(
        on_discover_ftrack_framework_nuke, session
    )
