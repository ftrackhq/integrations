...
project = u'framework_maya'
copyright = u'2022, ftrack'
author = u'ftrack'

# contents of docs/conf.py
try:
    release = get_distribution('framework_maya').version
...
modindex_common_prefix = ['framework_maya.']
...
htmlhelp_basename = 'framework_mayadoc'
...
latex_documents = [
    (
        master_doc,
        'framework_maya.tex',
        u'framework_maya Documentation',
        u'ftrack',
        'manual',
    ),
]
