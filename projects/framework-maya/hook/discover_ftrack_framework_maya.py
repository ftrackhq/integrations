...
def on_discover_ftrack_framework_maya(session, event):
    from ftrack_framework_maya import __version__ as integration_version
...
def register(session):
    ...
    handle_discovery_event = functools.partial(
        on_discover_ftrack_framework_maya, session
    )
