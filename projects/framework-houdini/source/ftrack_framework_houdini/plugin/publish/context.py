...
class HoudiniPublisherContextPlugin(
    plugin.PublisherContextPlugin, HoudiniBasePlugin
):
...
class HoudiniPublisherContextPluginWidget(
    pluginWidget.PublisherContextPluginWidget, HoudiniBasePluginWidget
):
