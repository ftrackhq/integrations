...
project = u'framework_houdini'
copyright = u'2022, ftrack'
author = u'ftrack'

# contents of docs/conf.py
try:
    release = get_distribution('framework_houdini').version
...
modindex_common_prefix = ['framework_houdini.']
...
htmlhelp_basename = 'framework_houdinidoc'
...
latex_documents = [
    (
        master_doc,
        'framework_houdini.tex',
        u'framework_houdini Documentation',
        u'ftrack',
        'manual',
    ),
]
