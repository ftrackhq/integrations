...
def on_discover_ftrack_framework_houdini(session, event):
    from ftrack_framework_houdini import (
...
def register(session):
    ...
    handle_discovery_event = functools.partial(
        on_discover_ftrack_framework_houdini, session
    )
    ...
    handle_launch_event = functools.partial(
        on_launch_ftrack_framework_houdini, session
    )
