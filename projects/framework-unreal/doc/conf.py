...
project = u'framework_unreal'
copyright = u'2022, ftrack'
author = u'ftrack'

# contents of docs/conf.py
try:
    release = get_distribution('framework_unreal').version
...
modindex_common_prefix = ['framework_unreal.']
...
htmlhelp_basename = 'framework_unrealdoc'
...
latex_documents = [
    (
        master_doc,
        'framework_unreal.tex',
        u'framework_unreal Documentation',
        u'ftrack',
        'manual',
    ),
]
