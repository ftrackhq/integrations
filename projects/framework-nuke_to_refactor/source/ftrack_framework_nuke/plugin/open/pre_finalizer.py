...
class NukeOpenerPreFinalizerPlugin(
    plugin.OpenerPreFinalizerPlugin, NukeBasePlugin
):
...
class NukeOpenerPreFinalizerPluginWidget(
    pluginWidget.OpenerPreFinalizerPluginWidget, NukeBasePluginWidget
):
