...
class BatchPublisherDialog(BaseContextDialog):
    '''Default Framework Publisher dialog'''

    name = 'framework_batch_publisher_dialog'
    ...
    def __init__(
        ...
        *dialog_options*: Dictionary of arguments passed on to configure the
        ...
        super(BatchPublisherDialog, self).__init__(
            event_manager,
            client_id,
            connect_methods_callback,
            connect_setter_property_callback,
    ...
    def _on_run_button_clicked(self):
        ...
        super(BatchPublisherDialog, self)._on_run_button_clicked()
    ...
    def closeEvent(self, event):
        ...
        if self._accordion_widgets_registry:
            for accordion in self._accordion_widgets_registry:
                accordion.teardown()
        super(BatchPublisherDialog, self).closeEvent(event)
