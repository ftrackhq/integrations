...
project = u'framework_3dsmax'
copyright = u'2022, ftrack'
author = u'ftrack'

# contents of docs/conf.py
try:
    release = get_distribution('framework_3dsmax').version
...
modindex_common_prefix = ['framework_3dsmax.']
...
htmlhelp_basename = 'framework_3dsmaxdoc'
...
latex_documents = [
    (
        master_doc,
        'framework_3dsmax.tex',
        u'framework_3dsmax Documentation',
        u'ftrack',
        'manual',
    ),
]
