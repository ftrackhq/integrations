...
project = u'ftrack_framework_maya'
copyright = u'2022, ftrack'
author = u'ftrack'

# contents of docs/conf.py
try:
    release = get_distribution('ftrack_framework_maya').version
...
modindex_common_prefix = ['ftrack_framework_maya.']
...
htmlhelp_basename = 'ftrack_framework_mayadoc'
...
latex_documents = [
    (
        master_doc,
        'ftrack_framework_maya.tex',
        u'ftrack_framework_maya Documentation',
        u'ftrack',
        'manual',
    ),
]
