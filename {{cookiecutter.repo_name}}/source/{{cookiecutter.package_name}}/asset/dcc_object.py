...
class {{cookiecutter.host_type_capitalized}}DccObject(DccObject):
    ...
    def from_asset_info_id(self, asset_info_id):
        '''
        Checks {{cookiecutter.host_type}} scene to get all the ftrackAssetNode objects. Compares them
    ...
    def dictionary_from_object(object_name):
        ...
        *object_name* ftrackAssetNode object type from {{cookiecutter.host_type}} scene.
        '''
