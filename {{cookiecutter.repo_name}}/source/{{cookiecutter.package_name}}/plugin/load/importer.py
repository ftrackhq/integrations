...
class {{cookiecutter.host_type|capitalize}}LoaderImporterPlugin(plugin.LoaderImporterPlugin, {{cookiecutter.host_type|capitalize}}BasePlugin):
...
class {{cookiecutter.host_type|capitalize}}LoaderImporterPluginWidget(
    pluginWidget.LoaderImporterPluginWidget, {{cookiecutter.host_type|capitalize}}BasePluginWidget
):
