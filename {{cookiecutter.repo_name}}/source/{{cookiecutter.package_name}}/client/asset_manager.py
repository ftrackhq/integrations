...
class {{cookiecutter.host_type|capitalize}}QtAssetManagerClientWidget(QtAssetManagerClientWidget):
    ui_types = [
        constants.UI_TYPE,
    ...
    def __init__(self, event_manager, asset_list_model, parent=None):
        super({{cookiecutter.host_type|capitalize}}QtAssetManagerClientWidget, self).__init__(
            event_manager, asset_list_model, parent=parent
        )
        self.setWindowTitle('{{cookiecutter.host_type|capitalize}} Pipeline Asset Manager')
