...
class {{cookiecutter.host_type|capitalize}}QtSaveClientWidget(QtSaveClientWidget):
    '''Client for doing an incremental save of {{cookiecutter.host_type|capitalize}} scene locally
