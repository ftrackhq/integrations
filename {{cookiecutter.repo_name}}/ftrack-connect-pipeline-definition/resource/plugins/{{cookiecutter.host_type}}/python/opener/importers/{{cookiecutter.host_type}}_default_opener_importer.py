...
class {{cookiecutter.host_type|capitalize}}DefaultOpenerImporterPlugin(plugin.{{cookiecutter.host_type|capitalize}}OpenerImporterPlugin):
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = {{cookiecutter.host_type|capitalize}}DefaultOpenerImporterPlugin(api_object)
    plugin.register()
