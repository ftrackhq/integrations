...
class {{cookiecutter.host_type|capitalize}}DefaultLoaderImporterOptionsWidget(LoadBaseWidget):
    ...
    def __init__(
        ...
        super({{cookiecutter.host_type|capitalize}}DefaultLoaderImporterOptionsWidget, self).__init__(
            parent=parent,
            session=session,
            data=data,
            name=name,
    ...
    def build(self):
        super({{cookiecutter.host_type|capitalize}}DefaultLoaderImporterOptionsWidget, self).build()
    ...
    def post_build(self):
        super({{cookiecutter.host_type|capitalize}}DefaultLoaderImporterOptionsWidget, self).post_build()
    ...
    def set_defaults(self):
        super({{cookiecutter.host_type|capitalize}}DefaultLoaderImporterOptionsWidget, self).set_defaults()
    ...
    def _on_load_mode_changed(self, radio_button):
        ...
        super(
            {{cookiecutter.host_type|capitalize}}DefaultLoaderImporterOptionsWidget, self
...
class {{cookiecutter.host_type|capitalize}}DefaultLoaderImporterPluginWidget(
    plugin.{{cookiecutter.host_type|capitalize}}LoaderImporterPluginWidget
):
    plugin_name = '{{cookiecutter.host_type}}_default_loader_importer'
    widget = {{cookiecutter.host_type|capitalize}}DefaultLoaderImporterOptionsWidget
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = {{cookiecutter.host_type|capitalize}}DefaultLoaderImporterPluginWidget(api_object)
    plugin.register()
