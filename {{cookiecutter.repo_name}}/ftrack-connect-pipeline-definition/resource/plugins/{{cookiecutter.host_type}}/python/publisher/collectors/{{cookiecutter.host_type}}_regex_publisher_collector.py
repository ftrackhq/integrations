...
class {{cookiecutter.host_type|capitalize}}RegexPublisherCollectorPlugin(plugin.{{cookiecutter.host_type|capitalize}}PublisherCollectorPlugin):
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = {{cookiecutter.host_type|capitalize}}RegexPublisherCollectorPlugin(api_object)
    plugin.register()
