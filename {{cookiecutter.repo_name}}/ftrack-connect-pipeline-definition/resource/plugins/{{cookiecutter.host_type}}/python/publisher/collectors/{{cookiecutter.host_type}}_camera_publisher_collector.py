...
class {{cookiecutter.host_type|capitalize}}CameraPublisherCollectorPlugin(plugin.{{cookiecutter.host_type|capitalize}}PublisherCollectorPlugin):
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = {{cookiecutter.host_type|capitalize}}CameraPublisherCollectorPlugin(api_object)
    plugin.register()
