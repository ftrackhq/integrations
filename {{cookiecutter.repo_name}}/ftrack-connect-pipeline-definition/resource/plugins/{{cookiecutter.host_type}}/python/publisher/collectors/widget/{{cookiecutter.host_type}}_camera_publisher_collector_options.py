...
class {{cookiecutter.host_type|capitalize}}CameraPublisherCollectorOptionsWidget(BaseOptionsWidget):
    ...
    def __init__(
        ...
        super({{cookiecutter.host_type|capitalize}}CameraPublisherCollectorOptionsWidget, self).__init__(
            parent=parent,
            session=session,
            data=data,
            name=name,
    ...
    def build(self):
        ...
        super({{cookiecutter.host_type|capitalize}}CameraPublisherCollectorOptionsWidget, self).build()
    ...
    def post_build(self):
        super({{cookiecutter.host_type|capitalize}}CameraPublisherCollectorOptionsWidget, self).post_build()
...
class {{cookiecutter.host_type|capitalize}}CameraPublisherCollectorPluginWidget(
    ...
    widget = {{cookiecutter.host_type|capitalize}}CameraPublisherCollectorOptionsWidget
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = {{cookiecutter.host_type|capitalize}}CameraPublisherCollectorPluginWidget(api_object)
    plugin.register()
