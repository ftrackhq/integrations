...
class {{cookiecutter.host_type|capitalize}}GeometryPublisherValidatorPlugin(
    plugin.{{cookiecutter.host_type|capitalize}}PublisherValidatorPlugin
):
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = {{cookiecutter.host_type|capitalize}}GeometryPublisherValidatorPlugin(api_object)
    plugin.register()
