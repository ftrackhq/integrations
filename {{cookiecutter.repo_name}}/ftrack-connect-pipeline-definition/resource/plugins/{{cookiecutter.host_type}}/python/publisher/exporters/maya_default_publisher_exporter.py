...
class {{cookiecutter.host_type|capitalize}}DefaultPublisherExporterPlugin(plugin.{{cookiecutter.host_type|capitalize}}PublisherExporterPlugin):
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    output_plugin = {{cookiecutter.host_type|capitalize}}DefaultPublisherExporterPlugin(api_object)
