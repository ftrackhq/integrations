...
class {{cookiecutter.host_type|capitalize}}ReviewablePublisherExporterPlugin(
    plugin.{{cookiecutter.host_type|capitalize}}PublisherExporterPlugin
):
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = {{cookiecutter.host_type|capitalize}}ReviewablePublisherExporterPlugin(api_object)
    plugin.register()
