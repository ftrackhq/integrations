...
class {{cookiecutter.host_type|capitalize}}ThumbnailPublisherExporterPlugin(plugin.{{cookiecutter.host_type|capitalize}}PublisherExporterPlugin):
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = {{cookiecutter.host_type|capitalize}}ThumbnailPublisherExporterPlugin(api_object)
    plugin.register()
