...
connect_dependency_link = (
    'https://bitbucket.org/ftrack/ftrack-connect/get/backlog/simplify-extension-o-ftrack-connect-package/documentation.zip'
...
connect_nuke_studio_dependency_link = (
    'https://bitbucket.org/ftrack/ftrack-connect-nuke-studio/get/0.2.1.zip'
    '#egg=ftrack-connect-nuke-studio-0.2.1'
)
