...
from ftrack_framework_core.client.asset_manager import AssetManagerClient
from ftrack_framework_qt.ui.utility.widget.button import RemoveButton
...
class QtAssetManagerClientWidget(QtAssetManagerClient, QtWidgets.QFrame):
    ...
    def __init__(
        ...
        :*event_manager*: : instance of :class:`~ftrack_framework_core.event.EventManager`

        :*asset_list_model*: : instance of :class:`~ftrack_framework_qt.ui.asset_manager.model.AssetListModel`
