...
from ftrack_framework_qt.ui.asset_manager.base import (
    AssetManagerBaseWidget,
    AssetListWidget,
)
from ftrack_framework_qt.ui.utility.widget.circular_button import (
    CircularButton,
)
from ftrack_framework_qt.ui.utility.widget.base.accordion_base import (
    AccordionBaseWidget,
)
from ftrack_framework_core.utils import str_version
from ftrack_framework_qt.utils import set_property
from ftrack_framework_qt.ui.utility.widget.thumbnail import (
...
from ftrack_framework_qt.utils import clear_layout
from ftrack_framework_qt.ui.utility.widget.dialog import ModalDialog
from ftrack_framework_qt.ui.utility.widget.busy_indicator import (
    BusyIndicator,
)
from ftrack_framework_qt.ui.utility.widget.button import ApproveButton
...
class AssetManagerWidget(AssetManagerBaseWidget):
    ...
    def __init__(self, asset_manager_client, asset_list_model, parent=None):
        ...
        :param asset_manager_client: :class:`~ftrack_framework_qt.client.asset_manager.QtAssetManagerClient` instance
        :param asset_list_model: : instance of :class:`~ftrack_framework_qt.ui.asset_manager.model.AssetListModel`
    ...
    def _listen_widget_updates(self):
        '''Subscribe to the NOTIFY_PLUGIN_PROGRESS_TOPIC topic to call the
...
class AssetManagerListWidget(AssetListWidget):
    ...
    def __init__(self, model, asset_widget_class, docked=False, parent=None):
        ...
        :param model: :class:`~ftrack_framework_qt.ui.asset_manager.model.AssetListModel` instance
        :param asset_widget_class: The class inheriting from :class:`~ftrack_framework_qt.ui.asset_manager.AssetWidget` to use when instantiating assets
...
class AssetWidget(AccordionBaseWidget):
    ...
    def __init__(self, index, event_manager, docked=False, parent=None):
        ...
        :param event_manager:  :class:`~ftrack_framework_core.event.EventManager` instance
        :param docked: Boolean telling if the list is docked in DCC or is within an ftrack dialog - drive style
        :param parent: The parent dialog or frame
        '''
