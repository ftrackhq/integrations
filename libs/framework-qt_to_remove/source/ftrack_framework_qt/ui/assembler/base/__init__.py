...
from ftrack_framework_core.client import constants
from ftrack_framework_core.constants import plugin
from ftrack_framework_core.definition.definition_object import (
    DefinitionObject,
    DefinitionList,
)
...
from ftrack_framework_qt.ui.factory.assembler import (
    AssemblerWidgetFactory,
)
from ftrack_framework_qt.ui.utility.widget.base.accordion_base import (
    AccordionBaseWidget,
)
from ftrack_framework_qt.ui.asset_manager import (
    AssetVersionStatusWidget,
)
from ftrack_framework_core.utils import str_version
from ftrack_framework_qt.utils import (
    set_property,
    clear_layout,
    get_main_framework_window_from_widget,
)
from ftrack_framework_qt.ui.utility.widget.version_selector import (
    VersionComboBox,
)
...
from ftrack_framework_qt.ui.utility.widget.search import Search
from ftrack_framework_qt.ui.utility.widget.button import OptionsButton
...
class ComponentBaseWidget(AccordionBaseWidget):
    ...
    def __init__(self, index, assembler_widget, event_manager, parent=None):
        ...
        :param assembler_widget: :class:`~ftrack_framework_qt.ui.assembler.base.AssemblerBaseWidget` instance
