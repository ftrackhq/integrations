...
class JavascriptRPC(object):
    ...
    def instance():
        ...
        assert JavascriptRPC._instance.connected, "DCC not connected, please keep panel open while integration is working!"
    ...
    def _initialise(self):
        ...
        assert self.dcc_version, f"{self.dcc_name.title()} integration requires {env_name} passed as environment variable!"
            ...
            while not reply_event:
                ...
                if waited > timeout:
                    raise Exception(
                        ...
                        " panel plugin installed and functioning?"
