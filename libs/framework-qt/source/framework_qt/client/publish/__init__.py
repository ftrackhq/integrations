...
from framework_core.client import constants as client_constants
from framework_core.client.publisher import PublisherClient

from framework_qt.utils import get_theme, set_theme
from framework_qt import constants as qt_constants
from framework_qt.ui.factory.publisher import (
...
class QtPublisherClientWidget(QtPublisherClient, QtWidgets.QFrame):
    ...
    def _build_button_widget(self):
        ...
        self.run_button = (
            framework_qt.ui.utility.widget.button.RunButton(
                'PUBLISH'
            )
        )
