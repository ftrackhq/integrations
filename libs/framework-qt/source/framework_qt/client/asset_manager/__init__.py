...
from framework_core.client.asset_manager import AssetManagerClient
from framework_qt.ui.utility.widget.button import RemoveButton
...
from framework_qt.utils import BaseThread, set_property
...
class QtAssetManagerClientWidget(QtAssetManagerClient, QtWidgets.QFrame):
    ...
    def __init__(
        ...
        :*event_manager*: : instance of :class:`~framework_core.event.EventManager`

        :*asset_list_model*: : instance of :class:`~framework_qt.ui.asset_manager.model.AssetListModel`
