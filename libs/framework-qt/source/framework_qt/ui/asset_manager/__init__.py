...
from framework_core.constants import asset as asset_constants
from framework_qt import constants as qt_constants
from framework_qt.ui.asset_manager.base import (
    AssetManagerBaseWidget,
    AssetListWidget,
)
from framework_qt.ui.utility.widget.circular_button import (
    CircularButton,
)
from framework_qt.ui.utility.widget.base.accordion_base import (
    AccordionBaseWidget,
)
from framework_core.utils import str_version
from framework_qt.utils import set_property
from framework_qt.ui.utility.widget.thumbnail import (
...
from framework_qt.utils import clear_layout
from framework_qt.ui.utility.widget.dialog import ModalDialog
from framework_qt.ui.utility.widget.busy_indicator import (
    BusyIndicator,
)
from framework_qt.ui.utility.widget.button import ApproveButton
...
class AssetManagerWidget(AssetManagerBaseWidget):
    ...
    def __init__(self, asset_manager_client, asset_list_model, parent=None):
        ...
        :param asset_manager_client: :class:`~framework_qt.client.asset_manager.QtAssetManagerClient` instance
        :param asset_list_model: : instance of :class:`~framework_qt.ui.asset_manager.model.AssetListModel`
...
class AssetManagerListWidget(AssetListWidget):
    ...
    def __init__(self, model, asset_widget_class, docked=False, parent=None):
        ...
        :param model: :class:`~framework_qt.ui.asset_manager.model.AssetListModel` instance
        :param asset_widget_class: The class inheriting from :class:`~framework_qt.ui.asset_manager.AssetWidget` to use when instantiating assets
...
class AssetWidget(AccordionBaseWidget):
    ...
    def __init__(self, index, event_manager, docked=False, parent=None):
        ...
        :param event_manager:  :class:`~framework_core.event.EventManager` instance
        :param docked: Boolean telling if the list is docked in DCC or is within an ftrack dialog - drive style
        :param parent: The parent dialog or frame
        '''
