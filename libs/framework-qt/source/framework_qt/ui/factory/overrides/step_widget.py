...
from framework_qt.ui.factory.base import BaseUIWidgetObject
...
from framework_qt.ui.utility.widget import overlay
from framework_qt import utils
from framework_qt.ui.utility.widget import icon, scroll_area
from framework_qt.plugin.widget import BaseOptionsWidget
from framework_qt.ui.utility.widget.accordion import (
    AccordionWidget,
)
...
def recursive_get_load_mode_container(widget):
    '''Recursively search layout of *widget* and locate a widget inheriting from :class: `framework_qt.plugin.widgets.load_widget.LoadBaseWidget`'''
