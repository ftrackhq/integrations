...
import framework_qt.ui.utility.widget.button
from Qt import QtWidgets, QtCore, QtGui

import shiboken2

from framework_qt.ui.utility.widget.thumbnail import Context
...
class EntityBrowser(dialog.ModalDialog):
    ...
    def get_approve_button(self):
        '''(Override)'''
        return (
            framework_qt.ui.utility.widget.button.ApproveButton(
    ...
    def get_deny_button(self):
        '''(Override)'''
        return framework_qt.ui.utility.widget.button.DenyButton(
            "CANCEL", width=80
        )
...
class EntityBrowserNavigator(InputEventBlockingWidget):
    ...
    def __init__(
        ...
        :param entity_browser: :class:`~framework_qt.ui.utility.widget.entity_browser.EntityBrowser` instance
