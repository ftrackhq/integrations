...
from framework_core.client import constants
from framework_core.constants import plugin
from framework_core.definition.definition_object import (
    DefinitionObject,
    DefinitionList,
)
...
from framework_qt.ui.utility.widget.search import Search
from framework_qt.ui.utility.widget.button import OptionsButton
...
class ComponentBaseWidget(AccordionBaseWidget):
    ...
    def __init__(self, index, assembler_widget, event_manager, parent=None):
        ...
        :param assembler_widget: :class:`~framework_qt.ui.assembler.base.AssemblerBaseWidget` instance
