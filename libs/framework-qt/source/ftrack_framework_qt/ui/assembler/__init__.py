...
from ftrack_framework_qt.ui.utility.widget.entity_browser import (
    EntityBrowser,
)

from ftrack_framework_qt.ui.assembler.base import (
    AssemblerBaseWidget,
...
class AssemblerDependenciesWidget(AssemblerBaseWidget):
    ...
    def __init__(self, client):
        ...
        :param client: :class:`~ftrack_framework_qt.client.load.QtAssemblerWidget` instance
        '''
