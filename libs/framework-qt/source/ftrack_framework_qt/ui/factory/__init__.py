...
from ftrack_framework_qt.ui.factory import (
    overrides as override_widgets,
    default as default_widgets,
)
from ftrack_framework_qt.ui.factory.ui_overrides import (
    UI_OVERRIDES,
)
...
#  have all standrad connections, or maybe should they be in core? if widget,
#  then connect with bla bla? See maya project as example.
class WidgetFactoryBase(QtWidgets.QWidget):
    ...
    def __init__(self, event_manager, ui_types, parent=None):
        ...
        *event_manager* :class:`ftrack_framework_core.event.EventManager` instance
