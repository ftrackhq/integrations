...
from ftrack_framework_qt.ui.utility.widget import overlay
from ftrack_framework_qt import utils
from ftrack_framework_qt.ui.utility.widget import icon, scroll_area
from ftrack_framework_qt.plugin.widget import BaseOptionsWidget
from ftrack_framework_qt.ui.utility.widget.accordion import (
    AccordionWidget,
)
...
def recursive_get_load_mode_container(widget):
    '''Recursively search layout of *widget* and locate a widget inheriting from :class: `ftrack_framework_qt.plugin.widgets.load_widget.LoadBaseWidget`'''
