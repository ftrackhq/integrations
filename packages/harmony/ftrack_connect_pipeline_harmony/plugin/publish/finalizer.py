...
class HarmonyPublisherFinalizerPlugin(
    plugin.PublisherFinalizerPlugin, HarmonyBasePlugin
):
    ...
    def _run(self, event):
        ...
        super_result = super(HarmonyPublisherFinalizerPlugin, self)._run(event)

        return super_result


class HarmonyPublisherFinalizerPluginWidget(
    pluginWidget.PublisherFinalizerPluginWidget, HarmonyBasePluginWidget
):
