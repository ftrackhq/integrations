...
class HarmonyPublisherContextPlugin(
    plugin.PublisherContextPlugin, HarmonyBasePlugin
):
...
class HarmonyPublisherContextPluginWidget(
    pluginWidget.PublisherContextPluginWidget, HarmonyBasePluginWidget
):
