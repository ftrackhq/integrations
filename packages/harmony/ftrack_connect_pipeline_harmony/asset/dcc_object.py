...
class HarmonyDccObject(DccObject):
    ...
    def __init__(self, name=None, from_id=None, **kwargs):
        ...
        *from_id* as assset_info_id.
        ...
        super(HarmonyDccObject, self).__init__(name, from_id, **kwargs)
    ...
    def __setitem__(self, k, v):
        ...
        #     )
        super(HarmonyDccObject, self).__setitem__(k, v)
    ...
    def from_asset_info_id(self, asset_info_id):
        '''
        Checks harmony scene to get all the ftrackAssetNode objects. Compares them
    ...
    def dictionary_from_object(object_name):
        ...
        *object_name* ftrackAssetNode object type from harmony scene.
        '''
    ...
    def connect_objects(self, objects):
        ...
        :obj:`name` object asset_link attribute in harmony.

        *objects* List of Harmony DAG objects
        '''
        for obj in objects:
