...
def on_launch_integration(session, event):
    ...
    #
    integration_version = launch_data['application']['version'].version[0]
    ...
    #
    bootstrap_path = launch_data['config'][
        'bootstrap_path'
    ]  # os.path.join(connect_plugin_path, 'resource', 'bootstrap')
