...
@click.option(
    "--identifier",
    type=str,
    default=lambda: connect_identifier(),
    show_default="Generated by connect_identifier()",
    help="Unique identifier for the session. Defaults to a system-generated identifier.",
)
@click.option(
    "--api-user",
    type=str,
...
def authenticate(method, server_url, identifier, api_user, api_key):
    """
    ...
    """
    try:
        auth = Authenticate(server_url, identifier)
