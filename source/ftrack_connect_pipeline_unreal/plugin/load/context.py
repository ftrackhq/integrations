...
class UnrealLoaderContextPlugin(plugin.LoaderContextPlugin, UnrealBasePlugin):
...
class UnrealLoaderContextPluginWidget(
    pluginWidget.LoaderContextPluginWidget, UnrealBasePluginWidget
):
