...
class MenuActionPluginValidation(BasePluginValidation):
    ...
    def __init__(self, plugin_name, required_output, return_type, return_value):
        ...
        *return_value* return value of the current plugin stored at the
        plugin base class
        '''
        super(MenuActionPluginValidation, self).__init__(
...
class BaseMenuActionPlugin(BasePlugin):
    ...
    '''
    return_type = list
    plugin_type = plugin._PLUGIN_MENU_ACTION_TYPE
    _required_output = []
    ...
    def __init__(self, session):
        ...
        *session* should be the :class:`ftrack_api.session.Session` instance
        ...
        '''
        super(BaseMenuActionPlugin, self).__init__(session)
        self.validator = MenuActionPluginValidation(
