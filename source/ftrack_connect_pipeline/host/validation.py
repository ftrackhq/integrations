...
class PluginDiscoverValidation(object):
    ...
    def vaildate_definition_plugins(
        ...
        *schema_type* : Schema type of the current definition.
        ...
        return is_valid
    # TODO: Remove this validators once validation is working
    ...
    #
    #     is_valid = True
    #     for finalizer in finalizers_list:
    #         for finalizer_stage in finalizer['stages']:
    #             stage_name = finalizer_stage['name']
    #             plugin_type = '{}.{}'.format(schema_type, stage_name)
    #             for finalizer_plugin in finalizer_stage['plugins']:
    #                 if not self._discover_plugin(
    #                         finalizer_plugin,
    #                         plugin_type
    #                 ):
