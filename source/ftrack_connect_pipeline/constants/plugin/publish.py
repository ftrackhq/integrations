...
PLUGIN_PUBLISHER_POST_FINALIZER_TYPE = 'publisher.{}'.format(plugin._PLUGIN_POST_FINALIZER_TYPE)
#: Publisher plugin type for pre finalizer plugins
PLUGIN_PUBLISHER_PRE_FINALIZER_TYPE = 'publisher.{}'.format(plugin._PLUGIN_PRE_FINALIZER_TYPE)
