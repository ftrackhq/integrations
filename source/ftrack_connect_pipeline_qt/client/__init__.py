...
class QtClient(client.Client, QtWidgets.QWidget):
    ...
    def _definition_changed(self, host_connection, schema, definition):
        ...
        *schema* and *definition*'''
        ...
        #self.scroll.layout().addWidget(self._current_def)
        self.scroll.setWidget(self._current_def)
        #self.layout().addWidget(self._current_def)
        #self._current_def.setMinimumSize(500, 1000)
        #self._current_def.layout().setSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
