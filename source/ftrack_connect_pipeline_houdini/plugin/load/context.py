...
class LoaderContextHoudiniPlugin(plugin.LoaderContextPlugin, BaseHoudiniPlugin):
...
class LoaderContextHoudiniWidget(
    pluginWidget.LoaderContextWidget, BaseHoudiniPluginWidget
):
