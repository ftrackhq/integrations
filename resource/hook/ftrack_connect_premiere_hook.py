...
class PremiereLaunchAction(object):
    '''Premiere discover and launch action.'''

    identifier = 'ftrack-connect-launch-premiere'
    ...
    def __init__(self, applicationStore, launcher):
        ...
        *launcher* should be an instance of
        ...
        '''
        super(PremiereLaunchAction, self).__init__()
...
def register(registry, **kw):
    '''Register hooks for Premiere plugin.'''
    ...
    action = PremiereLaunchAction(applicationStore, launcher)
    action.register()
