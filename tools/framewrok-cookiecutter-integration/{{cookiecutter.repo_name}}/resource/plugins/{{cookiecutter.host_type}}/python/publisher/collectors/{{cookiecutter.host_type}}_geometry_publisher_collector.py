...
class {{cookiecutter.host_type_capitalized}}GeometryPublisherCollectorPlugin(
...
def register(api_object, **kw):
    if not isinstance(api_object, ftrack_api.Session):
        ...
        return
    plugin = {{cookiecutter.host_type_capitalized}}GeometryPublisherCollectorPlugin(api_object)
    plugin.register()
