...
project = 'ftrack-connect-pipeline-qt'
...
htmlhelp_basename = 'ftrack-connect-pipeline-qtdoc'
...
latex_documents = [
    (master_doc, 'ftrack-connect-pipeline-qt.tex', u'ftrack-connect-pipeline-qt Documentation',
     u'ftrack', 'manual'),
]
...
man_pages = [
    (master_doc, 'ftrack-connect-pipeline-qt', u'ftrack-connect-pipeline-qt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ftrack-connect-pipeline-qt', u'ftrack-connect-pipeline-qt Documentation',
     author, 'ftrack-connect-pipeline-qt', 'One line description of project.',
     'Miscellaneous'),
]
